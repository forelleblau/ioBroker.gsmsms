...
Blockly.Words['telegram_chatid'] = {
  'en': 'Recipient (Chat-ID, optional)',
  'de': 'Empfänger (Chat-ID, optional)',
  'ru': 'Получатель (Chat-ID, необязательно)',
  'pt': 'Destinatário (Chat-ID, opcional)',
  'nl': 'Ontvanger (Chat-ID, optioneel)',
  'fr': 'Destinataire (Chat-ID, facultatif)',
  'it': 'Destinatario (ID chat, facoltativo)',
  'es': 'Destinatario (Chat-ID, opcional)',
  'pl': 'Odbiorca (identyfikator czatu, opcjonalnie)',
  'zh-cn': '收件人（聊天 ID，可选）'
};
...
Blockly.Words['telegram_log_none'] = {
  'en': 'none',
  'pt': 'Nenhum',
  'pl': 'Żaden',
  'nl': 'geen',
...
Blockly.Words['telegram_log_info'] = {
  'en': 'info',
  'pt': 'info',
  'pl': 'informacje',
  'nl': 'Info',
...
Blockly.Words['telegram_log_debug'] = {
  'en': 'debug',
  'pt': 'depurar',
  'pl': 'odpluskwić',
  'nl': 'Debug',
...
Blockly.Words['telegram_log_warn'] = {
  'en': 'warning',
  'pt': 'Atenção',
  'pl': 'ostrzeżenie',
  'nl': 'waarschuwing',
...
Blockly.Words['telegram_log_error'] = {
  'en': 'error',
  'pt': 'erro',
  'pl': 'błąd',
  'nl': 'fout',
...
Blockly.Words['telegram_help'] = {
  'en': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'pt': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'pl': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'nl': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'it': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'es': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'fr': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'de': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md',
  'ru': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md'
};
Blockly.Words['telegram_silent'] = {
  'en': 'without notification',
  'de': 'ohne Benachrichtigung',
  'ru': 'без уведомления',
  'pt': 'sem notificação',
  'nl': 'zonder kennisgeving',
  'fr': 'sans notification',
  'it': 'senza notifica',
  'es': 'sin notificación',
  'pl': 'bez powiadomienia'
};
Blockly.Words['telegram_disable_web_preview'] = {
  'en': 'disable web preview',
  'de': 'Deaktivieren Sie die Webvorschau',
  'ru': 'отключить предварительный просмотр в Интернете',
  'pt': 'desativar a visualização da web',
  'nl': 'webvoorbeeld uitschakelen',
  'fr': 'désactiver l\'aperçu Web',
  'it': 'disabilitare l\'anteprima web',
  'es': 'deshabilitar la vista previa web',
  'pl': 'wyłącz podgląd internetowy',
  'zh-cn': '禁用网页预览'
};
...
Blockly.Blocks['gsmsms'] = {
  init: function() {
    ...
    var input = this.appendValueInput('RECIPIENT')
      .setCheck('String')
      .appendField(Blockly.Translate('gsmsms_number'));
...
/*
Blockly.Words['telegram_call'] = {
  'en': 'call via Telegram',
  'de': 'per Telegramm anrufen',
  'ru': 'звонок через Telegram',
  'pt': 'chamada via Telegram',
  'nl': 'bellen via Telegram',
  'fr': 'appeler par Telegram',
  'it': 'chiama via Telegram',
  'es': 'llamar por Telegram',
  'pl': 'połączenie za Telegram',
  'zh-cn': '通过电报电话'
};
Blockly.Words['telegram_call_system'] = {
  'en': 'System language',
  'de': 'Systemsprache',
  'ru': 'Системный язык',
...
Blockly.Words['telegram_call_help'] = {
  'en': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'pt': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'pl': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'nl': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'it': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'es': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'fr': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'de': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram',
  'ru': 'https://github.com/ioBroker/ioBroker.telegram/blob/master/README.md#calls-via-telegram'
};
Blockly.Words['telegram_call_repeats'] = {
  'en': 'Repeats',
  'de': 'Wiederholungen',
  'ru': 'Повторить',
  'pt': 'Repete',
...
Blockly.Blocks['telegram_call'] = {
  init: function() {
    var options = [
      [Blockly.Translate('telegram_anyInstance'), '']
    ];
    if (typeof main !== 'undefined' && main.instances) {
      for (var i = 0; i < main.instances.length; i++) {
